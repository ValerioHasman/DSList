...
import com.valeriodev.dslist.dto.SubstituicaoDTO;
...
public class GameListController {
  ...
  @PostMapping(value = "/{listId}/substituicao")
  public void move(@PathVariable Long listId, @RequestBody SubstituicaoDTO body){
